...
In this part we depict the security definition of MAC schemes in computational model.  The threat model of tag design is introduced first then the computational based security definition of MAC schemes. 
