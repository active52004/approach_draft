...
Let \{0,1\}$^n$ be the set of all n-bit binary strings. \nomenclature{\{0,1\}$^n$}{Set of all n-bit binary strings} The set of all binary string is expressed as \{0,1\}$^*$.  
...
%the adversary can conduct two types of attack on the memory frames
=======
In this part we depict the security definition of MAC schemes in the scenario of computational based security analysis. 
...
%the behaviour of the adversary under each attack
>>>>>>> 81181dba513321325fec0b42ca51887b24770f0a
...
%when x is pattern, y can collide
...
%when x pair is same base, y can collide
